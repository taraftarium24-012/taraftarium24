...
<body>
    ...
    <main>
      <section>
        <p>Taraftarium24 hd, Futbol tutkunları için en iyi canlı yayın platformu olan Taraftarium24 hd, 7/24 kesintisiz futbol heyecanı sunuyor. Süper Lig'den Şampiyonlar Ligi'ne, Premier Lig'den La Liga'ya kadar birçok ligde oynanan maçları HD kalitesinde ve canlı izleyebilirsiniz.</p>
      </section>
        <section>
            <h2>Taraftarium24 hd Canlı Maç İzle</h2>
            <ul>
